/*
O exercício proposto era para que o programador desenvolvesse um programa que alocasse a memória de 
acordo com o valor digitado pelo usuário e que em seguida essa memória fosse preenchida por Produtos (que seria uma estrutura),
além disso, o programador deveria apresentar qual dos produtos era o mais caro e qual possuía a maior quantidade de estoque.
*/
