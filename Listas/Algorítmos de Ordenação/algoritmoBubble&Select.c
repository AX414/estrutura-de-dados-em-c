...
ordenação de um vetor por Bubble-Sort e Select-Sort, além disso, há nele presente os dois tipos de buscas em que se pode ser realizada: Busca Exaustiva e Busca Sequencial (que é necessário um vetor ordenado para executar de forma correta).
*/
